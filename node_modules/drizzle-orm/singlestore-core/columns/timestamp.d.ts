...
import { SingleStoreDateBaseColumn, SingleStoreDateColumnBaseBuilder } from "drizzle-orm/singlestore-core/columns/date.common.js";
...
export declare class SingleStoreTimestampBuilder<T extends ColumnBuilderBaseConfig<'date', 'SingleStoreTimestamp'>> extends SingleStoreDateColumnBaseBuilder<T, SingleStoreTimestampConfig> {
    ...
    defaultNow(): import("drizzle-orm/column-builder.js").HasDefault<this>;
}
